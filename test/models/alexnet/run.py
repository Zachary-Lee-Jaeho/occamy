...
model = torch.hub.load('pytorch/vision:v0.5.0', 'alexnet', pretrained=True) #pretrained=True)
...
torch.onnx.export(model, input_batch, "alexnet.onnx", verbose=False)
...
sess = OMExecutionSession("./alexnet.so")
