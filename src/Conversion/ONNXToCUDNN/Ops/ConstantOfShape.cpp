...
//===--------- Start of ONNXConstantOfShapeOpToCUDNN ----------===//
...
struct ONNXConstantOfShapeOpToCUDNN : public ConversionPattern {
  static int constantOfShapeID;

  ONNXConstantOfShapeOpToCUDNN(TypeConverter &typeConverter, MLIRContext *context)
  ...
  LogicalResult matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    //---------- Making CUDNNConstantOfShape Operation ----------//
    ...
    auto constantGlobal = rewriter.create<KrnlGlobalOp>(loc, outMemRefType,
        ...
        /*name=*/
        rewriter.getStringAttr("constantofshape_cudnn_" + std::to_string(constantOfShapeID)),
        // /*value=*/constantValue,
    ...
    rewriter.create<CUDNNMemcpyOp>(loc, int32Ty,
...
int ONNXConstantOfShapeOpToCUDNN::constantOfShapeID;

void populateLoweringONNXConstantOfShapeOpToCUDNNPattern(
    RewritePatternSet &patterns, TypeConverter &typeConverter, MLIRContext *context) {
  patterns.insert<ONNXConstantOfShapeOpToCUDNN>(typeConverter, context);
}
//===---------- End of ONNXConstantOfShapeOpToCUDNN -----------===//
