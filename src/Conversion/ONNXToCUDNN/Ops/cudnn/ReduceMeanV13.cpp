...
//===--------- Start of ONNXReduceMeanV13OpToCUDNN ----------===//
...
struct ONNXReduceMeanV13OpToCUDNN : public ConversionPattern {
  ONNXReduceMeanV13OpToCUDNN(TypeConverter &typeConverter, MLIRContext *context)
  ...
  LogicalResult matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    int32_t reduceMode = 5; /*CUDNN_REDUCE_TENSOR_AVG*/

    //-------------- Making CUDNNReduce Operation --------------//
    ...
    auto cudnnReduce = rewriter.create<CUDNNReduceOp>(loc, outputMemRef,
...
void populateLoweringONNXReduceMeanV13OpToCUDNNPattern(
  ...
  patterns.insert<ONNXReduceMeanV13OpToCUDNN>(typeConverter, context);
}
//===---------- End of ONNXReduceMeanV13OpToCUDNN -----------===//
