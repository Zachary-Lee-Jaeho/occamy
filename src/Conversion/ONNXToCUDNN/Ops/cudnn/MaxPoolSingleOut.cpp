...
//===--------- Start of ONNXMaxPoolSingleOutOpToCUDNN ----------===//
...
struct ONNXMaxPoolSingleOutOpToCUDNN : public ConversionPattern {
  ONNXMaxPoolSingleOutOpToCUDNN(TypeConverter &typeConverter, MLIRContext *context)
  ...
  LogicalResult matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    auto cudnnMaxPool = rewriter.create<CUDNNMaxPoolOp>(loc, outputMemRef,
...
void populateLoweringONNXMaxPoolSingleOutOpToCUDNNPattern(
  ...
  patterns.insert<ONNXMaxPoolSingleOutOpToCUDNN>(typeConverter, context);
}
//===---------- End of ONNXMaxPoolSingleOutOpToCUDNN -----------===//
