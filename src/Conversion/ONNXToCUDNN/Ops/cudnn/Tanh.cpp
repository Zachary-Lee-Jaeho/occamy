...
struct ONNXTanhOpToCUDNN : public ConversionPattern {
  ONNXTanhOpToCUDNN(TypeConverter &typeConverter, MLIRContext *context)
...
void populateLoweringONNXTanhOpToCUDNNPattern(
  ...
  patterns.insert<ONNXTanhOpToCUDNN>(typeConverter, context);
}
//===---------- End of ONNXTanhOpToCUDNN -----------===//
