...
//===--------- Start of ONNXReduceMeanOpToCUDNN ----------===//
...
struct ONNXReduceMeanOpToCUDNN : public ConversionPattern {
  ONNXReduceMeanOpToCUDNN(TypeConverter &typeConverter, MLIRContext *context)
...
void populateLoweringONNXReduceMeanOpToCUDNNPattern(
  ...
  patterns.insert<ONNXReduceMeanOpToCUDNN>(typeConverter, context);
}
//===---------- End of ONNXReduceMeanOpToCUDNN -----------===//
