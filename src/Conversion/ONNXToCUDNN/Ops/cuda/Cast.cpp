...
struct ONNXCastOpToCUDNN : public ConversionPattern {
  ONNXCastOpToCUDNN(TypeConverter &typeConverter, MLIRContext *context)
  ...
  LogicalResult matchAndRewrite(Operation *op, ArrayRef<Value> operands,
    ...
    auto cudnnCastOp = rewriter.create<CUDNNCastOp>(loc,
...
void populateLoweringONNXCastOpToCUDNNPattern(
  ...
  patterns.insert<ONNXCastOpToCUDNN>(typeConverter, context);
}
//===---------- End of ONNXCastOpToCUDNN -----------===//
