...
struct ONNXPadOpToCUDNN : public ConversionPattern {
  ONNXPadOpToCUDNN(TypeConverter &typeConverter, MLIRContext *context)
...
void populateLoweringONNXPadOpToCUDNNPattern(
  ...
  patterns.insert<ONNXPadOpToCUDNN>(typeConverter, context);
}
//===---------- End of ONNXPadOpToCUDNN -----------===//
