...
//===--------- Start of ONNXSqueezeV11OpToCUDNN ----------===//
...
struct ONNXSqueezeV11OpToCUDNN : public ConversionPattern {
  ONNXSqueezeV11OpToCUDNN(TypeConverter &typeConverter, MLIRContext *context)
...
void populateLoweringONNXSqueezeV11OpToCUDNNPattern(
  ...
  patterns.insert<ONNXSqueezeV11OpToCUDNN>(typeConverter, context);
}
//===---------- End of ONNXSqueezeV11OpToCUDNN -----------===//
