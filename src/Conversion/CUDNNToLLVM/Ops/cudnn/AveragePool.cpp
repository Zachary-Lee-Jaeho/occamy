//===----------------------------------------------------------------------===//
// CUDNN to LLVM: CUDNNAveragePoolOpLowering
//===----------------------------------------------------------------------===//
...
class CUDNNAveragePoolOpLowering : public ConvertToLLVMPattern {
public:
  CUDNNAveragePoolOpLowering(MLIRContext *ctx, LLVMTypeConverter &typeConverter)
      : ConvertToLLVMPattern(
          mlir::CUDNNAveragePoolOp::getOperationName(), ctx, typeConverter) {}

  LogicalResult matchAndRewrite(Operation *op, ArrayRef<Value> operands,
      ConversionPatternRewriter &rewriter) const final {

    CUDNNAveragePoolOp averagePoolOp = dyn_cast<CUDNNAveragePoolOp>(op);
    ...
    auto callAveragePool = core_dnn::CUDNNRuntimeAPI::callApi(rewriter, loc,
        apiRegistry, CUDNNRuntimeAPI::API::CSRC_AVERAGEPOOL,
...
void mlir::populateCUDNNAveragePoolToLLVMConversionPattern(
    RewritePatternSet &patterns, MLIRContext *ctx, LLVMTypeConverter &typeConverter, Value handle) {
  patterns.insert<CUDNNAveragePoolOpLowering>(ctx, typeConverter);
