 ...
 */
class CUDNNDeallocOptPass
    : public PassWrapper<CUDNNDeallocOptPass, OperationPass<ModuleOp>> {
...
std::unique_ptr<Pass> core_dnn::createCUDNNDeallocOptPass() {
  return std::make_unique<CUDNNDeallocOptPass>();
}
